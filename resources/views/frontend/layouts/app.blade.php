...
<head>
    ...
    {{-- <link rel="apple-touch-icon" sizes="180x180"
        href="{{ asset('assets/frontend/assets/images/favicons/apple-touch-icon.png') }}" /> --}}

    {{-- <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('assets/frontend/assets/images/favicons/favicon-32x32.png') }}" /> --}}
    @isset($AppSettings->logo)
        <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('uploads/' . $AppSettings->logo) }}" />
    @endisset
    {{-- <link rel="icon" type="image/png" sizes="16x16"   
        href="{{ asset('assets/frontend/assets/images/favicons/favicon-16x16.png') }}" /> --}}
...
<body>
    ...
    <div class="page-wrapper">
        ...
        @elseif (isset($header) && $header == 3)
            @include('frontend.layouts.header-3')
        @else --}}
